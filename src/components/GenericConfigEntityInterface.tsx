...
import { GenericConfigCREATEModal } from "../components/modals/GenericConfigCREATEModal";
import { GenericConfigUPDATEModal } from "../components/modals/GenericConfigUPDATEModal";
...
export default function GenericConfigEntityInterface({ entity, title, description }: GenericEntityInterfaceProps) {
